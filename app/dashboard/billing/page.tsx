...
export default function Billing() {
    return (
        <div>
            ...
            <div className="py-6 md:py-[68px] pl-6 md:pl-[68px] pr-6 md:pr-[145px] border-l border-b flex items-center border-[#E1E1E1]">
            ...
            <div className="py-6 md:py-[68px] pl-6 md:pl-[68px] pr-6 md:pr-[145px] border-l border-b flex justify-between border-[#E1E1E1]">
                <p className="text-[24px] font-[600] leading-[25.2px] text-[#0D0040]">Billing</p>
            ...
            <div className="py-6 md:py-[68px] pl-6 md:pl-[68px] pr-6 md:pr-[145px] border-l border-b flex justify-between border-[#E1E1E1]">
                ...
                <div className="w-4/12 md:w-2/12 flex justify-between">
