                    ...
                    <div className="px-2 text-center">
                        <div className="px-0 sm:px-12">
                            ...
                            <div className="flex w-full mt-3 md:mt-[39.23px]">
                                ...
                                <p className="text-[13px] font-sans font-[700] leading-[25px] sm:leading-[20px] tracking-[1px] text-white">Click box to acknowledge <span className="text-[#FFD601] cursor-pointer">Privacy Statement</span> and <span className="text-[#FFD601] cursor-pointer">Terms of Service</span></p>
                            </div>
