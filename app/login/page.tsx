...
const Login = ({ }) => {
    return (
        <div className="h-[100vh] bg-gradient-to-r from-[#14005F80] to-[#0042A880] grid place-items-center">
            <div className="h-[85%] xl:w-4/12 lg:w-4/12 md:w-3/6 sm:w-9/12 rounded-lg bg-authformbackground p-2 max-h-[680px]">
                ...
                <div className="px-2 text-center">
                    <div className="px-12 pt-4">
                        ...
                        <div className="relative z-0 w-full mt-14 mb-5 group">
