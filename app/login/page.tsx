                ...
                <div className=" w-10/12 sm:w-[510px] box-content rounded-xl bg-authformbackground p-5 sm:p-[30px] h-max-[854px] lg:pb-[88px]">
                    ...
                    <div className="px-2 text-center">
                        <div className="px-0 sm:px-12">
                            <h1 className="text-[30px] sm:text-[40px] leading-10 font-[500] font-roboto text-white">Client Login</h1>
                            ...
                            <div className="z-0 w-full flex justify-start mt-[10px] sm:mt-[30px]">
                                <Link href={`/`} className="text-[#FFD601] leading-[16.34px] font-sans font-[700] text-[12px] underline left-0">
                                    Forgot password?
                                </Link>
                            </div>
                            <div className="relative z-0 w-full mt-[10px] sm:mt-[30px]">
                                <Link href={`/login/welcome`}>
                                    <button className="w-full h-[40px] sm:h-[61.5px] p-1 sm:p-[19px] text-[18px] font-lato font-bold text-black rounded-lg bg-[#FFD601]">Login</button>
                                </Link>
                            </div>
                        </div>
                        <p className="text-[13px] text-white font-sans font-[700] leading-[25px] sm:leading-4 mt-[24px]">By signing, I agree to VSE <span className="text-[#FFD601] cursor-pointer">Privacy Statement</span> and <span className="text-[#FFD601] cursor-pointer">Terms of Service</span></p>
                        <p className="text-[13px] text-white font-sans font-[700] leading-4 mt-[10px] sm:mt-[20px]">Do not have an account. &nbsp;
                        ...
                        <div className="px-0 sm:px-12 mt-[0px] sm:mt-[18px]">
                            <Link href={`/api/auth/login`}>
                                <button className="w-full h-[40px] sm:h-[61.5px] p-1 sm:p-[19px] text-[18px] font-lato font-bold text-black rounded-lg bg-white">
                                    Login with SSO
                                </button>
                            </Link>
                        </div>
