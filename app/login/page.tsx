            ...
            <div className="h-[100vh] bg-gradient-to-l from-[#14005F80] to-[#0042A880] grid place-items-center">
                <div className=" w-10/12 sm:w-[510px] box-content rounded-xl bg-authformbackground p-5 sm:p-[30px] h-max-[854px] lg:pb-[88px]">
                    ...
                    <div className="px-2 text-center">
                        ...
                        <p className="text-[13px] font-sans font-[700] leading-[25px] sm:leading-4 mt-[24px]">By signing, I agree to VSE <span className="text-[#FFD601] cursor-pointer">Privacy Statement</span> and <span className="text-[#FFD601] cursor-pointer">Terms of Service</span></p>
                        <p className="text-[13px] font-sans font-[700] leading-4 mt-[10px] sm:mt-[20px]">Do not have an account. &nbsp;
